...
<main class="app-shell">
    <section class="panel intro-panel">
        ...
        <div class="info-card">
            ...
            <p>Het systeem downloadt een Outlook-concept met professionele opmaak en een groene bookingknop. Open het bestand in Outlook, controleer de mail en klik zelf op verzenden.</p>
        </div>
    </section>
